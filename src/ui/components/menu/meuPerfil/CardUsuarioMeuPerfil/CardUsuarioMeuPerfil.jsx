...
function CardUsuarioMeuPerfil({ nomePerfil, tagPerfil, localizacaoEstadoPerfil, localizacaoCidadePerfil, fotoPerfil }) {
    ...
    <>
      ...
      <div className='cardUsuarioMeuPerfil'>
        ...
        <div className='cardUsuarioMeuPerfil__informacoesMeuPerfil'>
          ...
          {
            localizacaoEstadoPerfil === undefined ? (
              null
            ) : (
              localizacaoCidadePerfil === undefined ? (
                null
              ) : (
                <span className='informacoesMeuPerfil__localizacaoPerfil'>
                  <i>{IconObject.localizacaoMeuPerfil}</i>
                  {`${localizacaoCidadePerfil},${localizacaoEstadoPerfil}`}
                </span>
              )
            )
          }
